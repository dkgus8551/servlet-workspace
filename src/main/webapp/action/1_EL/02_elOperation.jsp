...
<body>
	...
	<p>
		* 스클릿틀립 방식<br>
		sOne과 sTwo가 일치합니까? <%= request.getAttribute("sOne")
		.equals(request.getAttribute("sTwo")) %><br>
		sOne과 sTwo가 일치합니까? <%= request.getAttribute("sOne")
		== (request.getAttribute("sTwo")) %>
	</p>
	<p>
		* EL 연산<br>
		...
		<!-- EL에서 == 비교는 자바의 equals() 방식으로 동작 -->
		sOne과 sTwo가 일치하지 않습니까? ${sOne != sTwo} 또는 ${sOne ne sTwo}<br>
		sOne에 저장된 값이 "안녕"과 일치합니까? ${sOne == "안녕"} 또는 ${sOne eq '안녕'}<br>
	</p>
	
	<hr>
	
	<h3>4. 객체가 null인지, 또는 List가 비어 있는지 체크할 수 있는 연산자</h3>
	<p>
		...
		lOne이 비어 있습니까? ${empty lOne}<br>
		lTwo가 비어 있습니까? ${empty lTwo}<br>
	</p>
